...
- **Databases:** MySQL & Relational Databases[cite: 50, 51].
- **Infrastructure:** Ubuntu Server, Nginx (Reverse Proxy), aaPanel, SSL (HTTPS) Configuration[cite: 54, 55].
- **Integrations:** Third-Party APIs (WhatsApp API Fonnte, Payment Gateway Midtrans)[cite: 19, 20, 53].
...
* **Real-time Mobile Streaming**
    * Membangun aplikasi mobile untuk manajemen streaming CCTV secara langsung menggunakan **React Vite** dan **Golang**[cite: 12].
* **Enterprise Web Systems**
    * Sistem Manajemen Alat Kesehatan untuk **RSUD Hadji Boejasin** (CI 4 & integrasi WhatsApp)[cite: 20].
